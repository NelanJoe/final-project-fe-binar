        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <div>
            <p className="text-justify text-white">
              Platform ini dibuat untuk memenuhi tugas final project binar
              academy yang dibuat oleh kelas frontend batch 2
            </p>
          </div>
          <div className="space-y-3">
            <h2 className="font-semibold text-center text-white">Our Team</h2>
            <div className="flex flex-row flex-wrap items-center justify-center gap-3">
              <Link to="https://github.com/jonathanqwerty" target="_blank">
              ...
              <Link to="https://github.com/Jhonitay" target="_blank">
                <div className="flex flex-col items-center">
                  <img
              ...
              <Link to="https://github.com/Yoga838" target="_blank">
                <div className="flex flex-col items-center">
                  <img
              ...
              <Link to="https://github.com/Rezahans" target="_blank">
                <div className="flex flex-col items-center">
                  <img
              ...
              <Link to="https://github.com/NelanJoe" target="_blank">
                <div className="flex flex-col items-center">
                  <img
              ...
              <Link to="https://github.com/Azzaxy1" target="_blank">
                <div className="flex flex-col items-center">
                  <img
